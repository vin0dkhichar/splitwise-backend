...
Revision ID: ded68f6093ae
Revises: 
Create Date: 2025-08-15 13:15:27.984291
...
def upgrade() -> None:
    ...
    sa.Column('amount', sa.Float(), nullable=False),
    sa.Column('group_id', sa.Integer(), nullable=True),
    sa.Column('expense_share_id', sa.Integer(), nullable=True),
    sa.Column('settled_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['expense_share_id'], ['expense_shares.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['group_id'], ['groups.id'], ondelete='CASCADE'),
