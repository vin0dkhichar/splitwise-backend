...
class GroupRepository:
    ...
    def update(self, db: Session, group_id: int, *, name: str, description: Optional[str]) -> Optional[Group]:
    ...
    def get_member(self, db: Session, group_id: int, user_id: int) -> Optional[GroupMember]:
        return (
