...
from app.services.expense_splitters import EqualExpenseSplitter, ExactExpenseSplitter, PercentageExpenseSplitter
...
class ExpenseService:
    ...
    def update_expense(self, db, expense_id: int, payload, expense_type: ExpenseType, requester_id: int):
        ...
        shares = splitter.update_shares(db, updated_expense, payload, requester_id=requester_id)
